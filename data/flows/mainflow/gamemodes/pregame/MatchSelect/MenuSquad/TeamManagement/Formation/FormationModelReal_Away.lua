--
local TableUtil = (...)
local BND_AWAY_FORMATION_INDEX = "bnd_away_formation_index"
local BND_AWAY_FORMATION_LIST = "bnd_away_formation_list"
local BND_AWAY_FORMATION = "bnd_away_formation"
...
function FormationModel:new(init)
  ...
  o.im.RegisterDataAction(BND_AWAY_FORMATION_INDEX, ACT_FORMATION_CHANGE, function(bindingName, actionName, formationIndex)
  ...
  o.im.Subscribe(BND_AWAY_FORMATION_INDEX, function()
    o:_publishFormationIndex()
  end
  )
  o.im.Subscribe(BND_AWAY_FORMATION_LIST, function()
    o:_publishFormationList()
  end
  )
  o.im.Subscribe(BND_AWAY_FORMATION, function()
    o:_publishFormation()
  end
  )
...
function FormationModel:_publishFormationIndex()
  self.im.Publish(BND_AWAY_FORMATION_INDEX, self.currentFormationIndex - 1)
end

function FormationModel:_publishFormationList()
  self.im.Publish(BND_AWAY_FORMATION_LIST, {
...
function FormationModel:_publishFormation()
  self.im.Publish(BND_AWAY_FORMATION, self.formationList[self.currentFormationIndex])
end
...
function FormationModel:finalize()
  ...
  self.im.UnregisterDataAction(BND_AWAY_FORMATION_INDEX, ACT_FORMATION_CHANGE)
  self.im.Unsubscribe(BND_AWAY_FORMATION_INDEX)
  self.im.Unsubscribe(BND_AWAY_FORMATION_LIST)
  self.im.Unsubscribe(BND_AWAY_FORMATION)
