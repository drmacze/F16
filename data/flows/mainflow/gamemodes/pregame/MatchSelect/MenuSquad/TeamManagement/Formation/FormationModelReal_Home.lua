-- REMOD BY LAOSIJI --
local TableUtil = (...)
local BND_HOME_FORMATION_INDEX = "bnd_home_formation_index"
local BND_HOME_FORMATION_LIST = "bnd_home_formation_list"
local BND_HOME_FORMATION = "bnd_home_formation"
...
function FormationModel:new(init)
  ...
  o.im.RegisterDataAction(BND_HOME_FORMATION_INDEX, ACT_FORMATION_CHANGE, function(bindingName, actionName, formationIndex)
  ...
  o.im.Subscribe(BND_HOME_FORMATION_INDEX, function()
    o:_publishFormationIndex()
  end
  )
  o.im.Subscribe(BND_HOME_FORMATION_LIST, function()
    o:_publishFormationList()
  end
  )
  o.im.Subscribe(BND_HOME_FORMATION, function()
    o:_publishFormation()
  end
  )
...
function FormationModel:_publishFormationIndex()
  self.im.Publish(BND_HOME_FORMATION_INDEX, self.currentFormationIndex - 1)
end

function FormationModel:_publishFormationList()
  self.im.Publish(BND_HOME_FORMATION_LIST, {
...
function FormationModel:_publishFormation()
  self.im.Publish(BND_HOME_FORMATION, self.formationList[self.currentFormationIndex])
end
...
function FormationModel:finalize()
  ...
  self.im.UnregisterDataAction(BND_HOME_FORMATION_INDEX, ACT_FORMATION_CHANGE)
  self.im.Unsubscribe(BND_HOME_FORMATION_INDEX)
  self.im.Unsubscribe(BND_HOME_FORMATION_LIST)
  self.im.Unsubscribe(BND_HOME_FORMATION)
