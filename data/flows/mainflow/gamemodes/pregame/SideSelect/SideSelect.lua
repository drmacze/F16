...
currentMatch = {
   isUserSideHome = 0, -- [0] Home, [1] Away, [2] Com, [3] Com
   HomeKitIndex = 0,
   AwayKitIndex = 1
}
...
function SideSelect:swapSides()
  ...
  elseif currentMatch.isUserSideHome == 1 then
    self:setUserSideAsCom1()
  elseif currentMatch.isUserSideHome == 2 then
    self:setUserSideAsHome()
  elseif currentMatch.isUserSideHome == 3 then
...
function SideSelect:setUserSideAsAway()
  ...
  self.comSideIcon1 = ICON_HIDE
  self.comSideIcon2 = ICON_HIDE
  currentMatch.isUserSideHome = 1
end
function SideSelect:setUserSideAsCom1()
  print("SideSelect:setUserSideAsCom1()")
  self.homeSideIcon = ICON_HIDE
  self.awaySideIcon = ICON_HIDE
  self.comSideIcon1 = ICON_COM
  self.comSideIcon2 = ICON_HIDE
  currentMatch.isUserSideHome = 2
end
function SideSelect:setUserSideAsCom2()
  print("SideSelect:setUserSideAsCom2()")
  self.homeSideIcon = ICON_HIDE
  self.awaySideIcon = ICON_HIDE
  self.comSideIcon1 = ICON_HIDE
  self.comSideIcon2 = ICON_COM
  currentMatch.isUserSideHome = 3
end
