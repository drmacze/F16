...
function MainHub:_openModPopup()
  local titleText = "INFO"
  local messageText = "DFL PREMIUM: CustomCup unlock (e.g., play the FIFA World Cup 2026 with 48 teams in 12 groups of 4 teams > round of 32. Champions League with 36 teams in league format > round of 16. UEFA Euro with 24 teams in 6 groups of 4 teams > round of 16. Copa America with 16 teams in 4 groups of 4 teams > quarter-finals...) Teams always updated with new player signings, new kits, classic teams, game fully translated into two different languages ​​(English & Portuguese)."
  local buttonClose = {
    icon = "$FooterIconNo",
    label = "Close",
    clickEvents = {
