...
function SelectLeagueTeam:getLeagues()
  ...
  self.leagueIDs = { -- Predefined league IDs
    13, 14, 60, 16 , 17, 19, 20, 2235, 31, 32, 341, 10, 308, 350, 50, 53, 54, 68, 39, 4, 7
  }
...
local EXCLUDED_TEAMS = {9, 10, 1, 241, 243, 240, 69, 65, 66, 219, 73, 32, 22, 21, 112172, 36, 44, 45, 47, 48, 52, 39, 245, 246, 247, 234, 236, 237, 86, 78, 327, 326, 325}
