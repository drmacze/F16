...
function FormationModel:getFormationList()
  ...
  for i = 1, #formationIDs do
    formationList[i] = {}
    formationList[i].id = formationIDs[i]
    formationList[i].name = formationNames[i].name
    formationList[i].coords = formationCoords[i]
    formationList[i].positions = formationPositions[i]
    self.formationNamesList[i] = {
      text = formationList[i].name
    }
  end
...
function FormationModel:getFormationPositions()
  local STRING_GK = self.loc.LocalizeString("GK")
  local STRING_RCB = self.loc.LocalizeString("RCB")
  local STRING_RB = self.loc.LocalizeString("RB")
  local STRING_RWB = self.loc.LocalizeString("RWB")
  local STRING_CB = self.loc.LocalizeString("CB")
  local STRING_LCB = self.loc.LocalizeString("LCB")
  local STRING_RM = self.loc.LocalizeString("RM")
  local STRING_RDM = self.loc.LocalizeString("RDM")
  local STRING_LB = self.loc.LocalizeString("LB")
  local STRING_RCM = self.loc.LocalizeString("RCM")
  local STRING_LDM = self.loc.LocalizeString("LDM")
  local STRING_CDM = self.loc.LocalizeString("CDM")
  local STRING_LCM = self.loc.LocalizeString("LCM")
  local STRING_LM = self.loc.LocalizeString("LM")
  local STRING_CAM = self.loc.LocalizeString("CAM")
  local STRING_RS = self.loc.LocalizeString("RS")
  local STRING_LS = self.loc.LocalizeString("LS")
  local STRING_RF = self.loc.LocalizeString("RF")
  local STRING_LF = self.loc.LocalizeString("LF")
  local STRING_ST = self.loc.LocalizeString("ST")
  local STRING_RW = self.loc.LocalizeString("RW")
  local STRING_LW = self.loc.LocalizeString("LW")
  local STRING_RAM = self.loc.LocalizeString("RAM")
  local STRING_LAM = self.loc.LocalizeString("LAM")
  local STRING_CM = self.loc.LocalizeString("CM")
  local STRING_LWB = self.loc.LocalizeString("LWB")
  local STRING_CF = self.loc.LocalizeString("CF")
  
  -- Posisi Formasi GameMode Real --
